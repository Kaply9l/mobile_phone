...
electronic2 = Category.create(title: 'Electronic', bytitle: 'electronic2', keywords: 'electronic',
                              description: 'electronic', parent: women)
mechanical2 = Category.create(title: 'Mechanical', bytitle: 'mechanical2', keywords: 'mechanical',
                              description: 'mechanical', parent: women)
...
electronic1 = Category.create(title: 'Electronic', bytitle: 'electronic1', keywords: 'electronic',
                              description: 'electronic', parent: men)
mechanical1 = Category.create(title: 'Mechanical', bytitle: 'mechanical1', keywords: 'mechanical',
                              description: 'mechanical', parent: men)
casio = Category.create(title: 'Casio', bytitle: 'casio', keywords: 'casio', description: 'casio', parent: mechanical1)
citizen = Category.create(title: 'Citizen', bytitle: 'citizen', keywords: 'citizen', description: 'citizen',
                          parent: electronic1)
royal = Category.create(title: 'Royal London', bytitle: 'royal-london', keywords: 'royal-london',
                        description: 'royal-london', parent: electronic1)

kids = Category.create(title: 'Kids', bytitle: 'kids', keywords: 'kids', description: 'for kids')
adriatica = Category.create(title: 'Adriatica', bytitle: 'adriatica', keywords: 'adriatica', description: 'adriatica',
                            parent: kids)
mechanical1 = Category.create(title: 'Anne Klein', bytitle: 'anne-klein', keywords: 'anne-klein',
                              description: 'anne-klein', parent: kids)
